...
h1=abs(real(h1a))+1i*abs(imag(h1a));
...
h2=abs(real(h2a))+1i*abs(imag(h2a));
...
h3=abs(real(h3a))+1i*abs(imag(h3a));
...
h4=abs(real(h4a))+1i*abs(imag(h4a));
